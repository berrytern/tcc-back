...
impl GestorService {
    pub fn new(repository: GestorRepository) -> Self{
        GestorService{
            repository
        }
    }
    ...
    pub async fn create_gestor(&self, user: CreateGestorModel) -> Result<Option<UserOutput>, AppError> {
    ...
    pub async fn update_gestor(&self, user: GestorUpdateModel, id: &ObjectId) -> Result<Option<UserOutput>, AppError> {
